...
namespace CustomerDetailSystem.Controllers
{
    ...
    public class CustomerDetailController : ControllerBase
    {
        ...
        public async Task<ActionResult<CustomerDetail>> PostCustomerDetail(CustomerDetail customerDetail)
        {
            ...
            return CreatedAtAction("GetCustomerDetail", new { id = customerDetail.CUST_ID }, customerDetail);
        }
        ...
        {
            return _context.CustomerDetails.Any(e => e.CUST_ID == id);
        }
    }
}
